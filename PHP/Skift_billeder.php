<?php
	...
	$sql = "(SELECT * FROM biler WHERE Type_Idtype = 01 ORDER BY rand() LIMIT 1) UNION
	(SELECT * FROM biler WHERE Type_Idtype = 02 ORDER BY rand() LIMIT 1)
	UNION
	(SELECT * FROM biler WHERE Type_Idtype = 03 ORDER BY rand() LIMIT 1)";
